...
def load_learned_patterns(json_file_path: str = 'meeting_patterns_learned.json') -> Dict:
    """
    Load learned patterns from JSON database.

    Args:
        json_file_path: Path to the patterns JSON file
...
def save_learned_pattern(pattern_type: str, pattern_key: str, destination: Dict,
                        context: Dict, json_file_path: str = 'meeting_patterns_learned.json'):
    """
    ...
    Args:
        ...
        json_file_path: Path to save the patterns JSON file
    """
...
def update_pattern_statistics(pattern_applied: bool, json_file_path: str = 'meeting_patterns_learned.json'):
    """
...
def add_project_alias(alias: str, folder_name: str, list_name: str,
                     json_file_path: str = 'meeting_patterns_learned.json'):
    """
